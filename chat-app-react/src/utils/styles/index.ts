...
import { ContextMenuProps, ConversationSelectedProps, MessageContainerProps, MessageItemContentProps, MessageItemLayoutProps, PageProps } from './styleTypes';
...
export const MessageItemContainer = styled.div<MessageContainerProps>`
	display: flex;
	gap: 20px;
	align-items: center;
...
`;
export const MessageItemLayout = styled.div<MessageItemLayoutProps>`
	display: flex;
